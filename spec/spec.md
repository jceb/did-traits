...
| <a id="resolvable_locally">Locally Resolvable</a>            | DID documents can be resolved in an ephameral local context, e.g. `did:peer`.                                                                                                                                                                                                                                                                                                                                                                      |
| <a id="resolvable_globally">Globally Resolvable</a>          | DID documents can be resolved globally.                                                                                                                                                                                                                                                                                                                                                                                                            |
| <a id="hosted_documents">Documents Hosting</a>               | Additional documents can be hosted with the DID Document and dereferenced via DID paths.                                                                                                                                                                                                                                                                                                                                                           |
...
| <a id="hosted_not">Not Hosted</a>                            | No hosting of DID Document required, e.g. ephameral `did:key` documents.                                                                                                                                                                                                                                                                                                                                                                           |
| <a id="hosted_centrally">Centrally Hosted</a>                | Hosted on a centralized service, e.g. a web server.                                                                                                                                                                                                                                                                                                                                                                                                |
| <a id="hosted_decentrally">Decentrally Hosted</a>            | Hosted on a decentralized service, e.g. a DLT.                                                                                                                                                                                                                                                                                                                                                                                                     |
